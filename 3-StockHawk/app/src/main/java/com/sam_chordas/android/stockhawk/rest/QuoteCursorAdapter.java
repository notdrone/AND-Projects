...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
  ...
  @Override public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor) {
    viewHolder.symbol.setText(cursor.getString(cursor.getColumnIndex("symbol")));
      viewHolder.symbol.setContentDescription(cursor.getString(cursor.getColumnIndex(QuoteColumns.NAME)));
      String bid_price = cursor.getString(cursor.getColumnIndex("bid_price"));
      Log.d(TAG, "onBindViewHolder: " + bid_price);
    ...
    if (Utils.showPercent) {
        ...
        viewHolder.change.setContentDescription(mContext.getString(R.string.a11y_percentage_change) + " " + percent_change);
    } else {
        String change = cursor.getString(cursor.getColumnIndex("change"));
        viewHolder.change.setText(change);
        viewHolder.change.setContentDescription(mContext.getString(R.string.a11y_percentage_change) + " " + change);
    }
  }
