...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                updateMuzei();
                notifyWeather();
                updateWear(cVVector.firstElement());
            }
    ...
    private void updateWear(ContentValues values) {
        ...
        String high = Utility.formatTemperature(getContext(), values.getAsDouble(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP));
        String low = Utility.formatTemperature(getContext(), values.getAsDouble(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP));
        String wind = Utility.formatTemperature(getContext(), values.getAsDouble(WeatherContract.WeatherEntry.COLUMN_WIND_SPEED));
        String humid = Utility.formatTemperature(getContext(), values.getAsDouble(WeatherContract.WeatherEntry.COLUMN_HUMIDITY));
        int weatherId = values.getAsInteger(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID);
        Drawable drawable;
        drawable = getContext().getResources().getDrawable(Utility.getIconResourceForWeatherCondition(weatherId));
        Bitmap icon = ((BitmapDrawable) drawable).getBitmap();

        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create("/gecko");
        putDataMapRequest.getDataMap().putString("low", low);
        putDataMapRequest.getDataMap().putString("high", high);
        putDataMapRequest.getDataMap().putString("wind", wind);
        putDataMapRequest.getDataMap().putString("humidity", humid);
        putDataMapRequest.getDataMap().putAsset("image", toAsset(icon));
        ...
        pendingResult.setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
            ...
            public void onResult(DataApi.DataItemResult dataItemResult) {
                Log.e("WEAR APP", "APPLICATION Result has come" + dataItemResult.getDataItem().toString());
